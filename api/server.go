...
func NewApiServer(config config.Config) *ApiServer {
	...
	for _, g := range []fiber.Router{v1, v1Full} {
		...
		// Developer Apps (Plans API - OAuth Bearer required)
		developerAppAuth := app.requireDeveloperAppAuth(config.AudiusApiSecret, "Plans app")
		g.Get("/developer_apps", developerAppAuth, app.v1UsersDeveloperApps)
		g.Get("/developer-apps", developerAppAuth, app.v1UsersDeveloperApps)
		g.Get("/developer_apps/:address", app.v1DeveloperApps)
		g.Get("/developer-apps/:address", app.v1DeveloperApps)
		g.Post("/developer_apps", developerAppAuth, app.postV1UsersDeveloperApp)
		g.Post("/developer-apps", developerAppAuth, app.postV1UsersDeveloperApp)
		g.Delete("/developer_apps/:address", developerAppAuth, app.deleteV1UsersDeveloperApp)
		g.Delete("/developer-apps/:address", developerAppAuth, app.deleteV1UsersDeveloperApp)
		g.Post("/developer_apps/:address/access-keys/deactivate", developerAppAuth, app.postV1UsersDeveloperAppAccessKeyDeactivate)
		g.Post("/developer-apps/:address/access-keys/deactivate", developerAppAuth, app.postV1UsersDeveloperAppAccessKeyDeactivate)
		g.Post("/developer_apps/:address/access-keys", developerAppAuth, app.postV1UsersDeveloperAppAccessKey)
		g.Post("/developer-apps/:address/access-keys", developerAppAuth, app.postV1UsersDeveloperAppAccessKey)
