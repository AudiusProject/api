...
func TestGetPlaylist(t *testing.T) {
	...
	status, body := testGet(t, app, "/v1/playlists/7eP5n", &playlistResponse)
...
func TestGetPlaylistFollowDownloadAccess(t *testing.T) {
	...
	// No access
	_, body1 := testGet(t, app, "/v1/playlists/ML51L", &playlistResponse)
	...
	_, body2 := testGetWithWallet(
		t, app,
		"/v1/playlists/ML51L?user_id=ELKzn",
...
func TestGetPlaylistUsdcPurchaseStreamAccess(t *testing.T) {
	...
	// No access
	_, body1 := testGet(t, app, "/v1/playlists/ELKzn", &playlistResponse)
	jsonAssert(t, body1, map[string]any{
	...
	_, body2 := testGetWithWallet(
		t, app,
		"/v1/playlists/ELKzn?user_id=1D9On",
...
func TestGetPlaylistUsdcPurchaseSelfAccess(t *testing.T) {
	...
	status, _ := testGet(
		t, app,
		"/v1/playlists/ELKzn?user_id="+trashid.MustEncodeHashID(3),
		&playlistResponse,
	)
